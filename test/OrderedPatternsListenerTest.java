...
public class OrderedPatternsListenerTest
{
	...
	public void setUp()
	{
		...
		m = new Model( "" );
		textInput = new JTextArea( "567" );
		patternInput = new JTextField( "123" );
		action = new ActionEvent( new JButton(), 0, "Show" );
		al = new OrderedPatternsListener( m, patternInput, textInput, new JTextArea(), new JProgressBar() );
	}
